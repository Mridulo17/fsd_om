...
@section('title') @lang('damaged_property.index_title') @endsection
...
@section('thead')
    <tr>
        <th width="5%">#</th>
        <th>@lang('damaged_property.label_name')</th>
        <th>@lang('damaged_property.label_bn_name')</th>
        <th width="5%">@lang('damaged_property.label_status')</th>
        <th width="12%">@lang('damaged_property.label_action')</th>
    </tr>
@endsection

@section('content')
    @component('components.breadcrumb')
        @slot('title')@lang('damaged_property.index_title')@endslot
        @slot('create_button')
            <a href="{{route('damaged_property.create')}}" class="btn btn-primary btn-sm waves-effect waves-light modal_lg_button">
                <i class="fa fa-plus-circle"></i> @lang('damaged_property.create_button_title')
            </a>
        @endslot
    @endcomponent
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('damaged_property.index') }}',
                type: 'get',
                dataType: 'JSON',
                cache: true,
            },
        ...
        $('#deleted_list_datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('damaged_property.deleted_list') }}',
                type: 'get',
                dataType: 'JSON',
                cache: true,
            },
        ...
        function statusChange(id){
            statusUpdate(id, '{{route('damaged_property.status')}}')
        }
    </script>
