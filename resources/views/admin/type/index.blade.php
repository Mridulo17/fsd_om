...
@section('title') @lang('type.index_title') @endsection
...
@section('thead')
    <tr>
        <th width="5%">#</th>
        <th>@lang('type.label_name')</th>
        <th>@lang('type.label_bn_name')</th>
        <th width="5%">@lang('type.label_status')</th>
        <th width="12%">@lang('type.label_action')</th>
    </tr>
@endsection

@section('content')
    @component('components.breadcrumb')
        @slot('title')@lang('type.index_title')@endslot
        @slot('create_button')
            <a href="{{route('type.create')}}" class="btn btn-primary btn-sm waves-effect waves-light modal_lg_button">
                <i class="fa fa-plus-circle"></i> @lang('type.create_button_title')
            </a>
        @endslot
    @endcomponent
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function statusChange(id){
            statusUpdate(id, '{{route('type.status')}}')
        }
    </script>
