<div class="row mb-3">
    <div class="col-md-6 col-sm-6 col-xs-12 my-2">
        @php /** @var string $errors */
            $error_class = $errors->has('department_id') ? 'parsley-error ' : ''; @endphp
        <label for="bn_name" class="form-label">@lang('division.division')</label>
        <sup class="text-danger">*</sup>
        <div class="form-group">
            {{ Form::select('department_id', $departments, null, ['class' => $error_class.'form-control select2', 'placeholder' => 'Select One', 'id' => 'department_id', 'required' => 1]) }}
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 my-2">
        ...
        <label for="name" class="form-label">@lang('sub_department.label_name')</label>
        <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 my-2">
        ...
        <label for="bn_name" class="form-label">@lang('sub_department.label_bn_name')</label>
        <sup class="text-danger">*</sup>
        <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 my-2">
        ...
        <label for="status" class="form-label">@lang('sub_department.label_status')</label>
        <sup class="text-danger">*</sup>
        <div class="form-group form-group-check pl-4">
            <div class="form-check-custom">
                ...
                <label class="form-check-label" for="active">
                    @lang('sub_department.label_status_active')
                </label>
            </div>
            ...
            <div class="form-check-custom">
                ...
                <label class="form-check-label" for="inactive">
                    @lang('sub_department.label_status_inactive')
                </label>
            </div>
...
<div class="row">
    <div class="col-md-12 text-right">
        <button type="submit" class="btn btn-primary waves-effect waves-light">
            <i class="fa fa-save"></i> @lang('sub_department.label_submit_button')
        </button>
    </div>
</div>
