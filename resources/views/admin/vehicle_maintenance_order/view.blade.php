                        ...
                        <tbody>
                            ...
                            @foreach($vehicle_maintenance_order->vehicleMaintenanceDetails as $key => $vehicle_maintenance_order)
                                <tr>
                                    ...
                                    <td>{{ $vehicle_maintenance_order->serial_number }}</td>
                                    <td>{{ $vehicle_maintenance_order->subject }}</td>
                                    ...
                                    <td>{{ $vehicle_maintenance_order->memorandum_number }}</td>
                                    <td>{{ $vehicle_maintenance_order->memorandum_date ? date('d-m-Y',strtotime($vehicle_maintenance_order->memorandum_date)) : '' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
