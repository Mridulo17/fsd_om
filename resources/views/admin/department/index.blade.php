...
@section('title') @lang('department.index_title') @endsection
...
@section('thead')
    <tr>
        <th width="5%">#</th>
        <th>@lang('department.label_name')</th>
        <th>@lang('department.label_bn_name')</th>
        <th width="5%">@lang('department.label_status')</th>
        <th width="12%">@lang('department.label_action')</th>
    </tr>
@endsection

@section('content')
    @component('components.breadcrumb')
        @slot('title')@lang('department.index_title')@endslot
        @slot('create_button')
            <a href="{{route('department.create')}}" class="btn btn-primary btn-sm waves-effect waves-light modal_lg_button">
                <i class="fa fa-plus-circle"></i> @lang('department.create_button_title')
            </a>
        @endslot
    @endcomponent
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('#deleted_list_datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('department.deleted_list') }}',
                type: 'get',
                dataType: 'JSON',
                cache: true,
            },
        ...
        function statusChange(id){
            statusUpdate(id, '{{route('department.status')}}')
        }
    </script>
