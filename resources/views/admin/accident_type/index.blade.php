...
@section('title') @lang('accident_type.index_title') @endsection
...
@section('thead')
    <tr>
        <th width="5%">#</th>
        <th>@lang('accident_type.label_name')</th>
        <th>@lang('accident_type.label_bn_name')</th>
        <th width="5%">@lang('accident_type.label_status')</th>
        <th width="12%">@lang('accident_type.label_action')</th>
    </tr>
@endsection

@section('content')
    @component('components.breadcrumb')
        @slot('title')@lang('accident_type.index_title')@endslot
        @slot('create_button')
            <a href="{{route('accident_type.create')}}" class="btn btn-primary btn-sm waves-effect waves-light modal_lg_button">
                <i class="fa fa-plus-circle"></i> @lang('accident_type.create_button_title')
            </a>
        @endslot
    @endcomponent
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('#deleted_list_datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('accident_type.deleted_list') }}',
                type: 'get',
                dataType: 'JSON',
                cache: true,
            },
        ...
        function statusChange(id){
            statusUpdate(id, '{{route('accident_type.status')}}')
        }
    </script>
