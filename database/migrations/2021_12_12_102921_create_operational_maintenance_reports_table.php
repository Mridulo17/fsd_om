...
class CreateOperationalMaintenanceReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('operational_maintenance_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('operational_maintenance_reports');
    }
}
