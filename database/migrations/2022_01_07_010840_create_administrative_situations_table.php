...
class CreateAdministrativeSituationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('administrative_situations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('administrative_situations');
    }
}
