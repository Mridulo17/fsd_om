...
class CreateDevelopmentTrainingSituationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('development_training_situations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('development_training_situations');
    }
}
